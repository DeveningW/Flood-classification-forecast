...
class GANDataset(torch.utils.data.Dataset):
    def __init__(self, forecast_range, mode, train_test_split_ratio, sample_length, dataset='WaterBench', training_set_scale=1):
        ...
        self.TunXi_feature = np.load(r'features.npy')
        self.TunXi_feature_cursor = 0

        csv_file = f'dataset/{dataset}/521_data.csv'
